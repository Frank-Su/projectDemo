...
import styles from '../../../style/componentStyle/sdComponentStyle/reusableStyle/questionTitle.scss';
 ...
 * @param labelIcon icon name of question
...
const QuestionTitle = (props: QuestionTitleProps) => {
  ...
  const labelList = {
    ...
    date: faCalendarDay,
    singleChoice: faDotCircle,
    table: faSitemap,
    multiChoice: faCheckSquare,
    numeric: faHashtag,
    // need to be replaced
    numericList: faLayerGroup,
    ranking: faTrophy,
    // need to be replaced
    grid: faBorderAll,
    // need to be replaced
  ...
  return (
    <div className={styles.ekasQTitleWrapper}>
      ...
      <div className={styles.ekasQTitleLeftPart}>
        <div className={styles.ekasQTitleLeftPartDisplayIcon}>
          <FontAwesomeIcon icon={labelList[props.labelIcon]} />
        </div>
